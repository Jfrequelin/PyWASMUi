...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0139b69f451defc6: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h346418c3ea3bbb97: (a: number, b: number, c: any) => void;
